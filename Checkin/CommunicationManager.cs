        ...
        void comPort_DataReceived(object sender, SerialDataReceivedEventArgs e)
        {
            ...
            switch (CurrentTransmissionType)
            {
                ...
                case TransmissionType.Text:
                    ...
                    {
                        if (IsNatural_Number(Convert.ToString(temp_msg[i])))
                        {
                            DisplayData(MessageType.Incoming, Convert.ToString(temp_msg[i]));
                        }
                    }
                    break;
                //user chose binary
                ...
                default:
                    ...
                    {
                        if (IsNatural_Number(Convert.ToString(temp[i])))
                        {
                            DisplayData(MessageType.Incoming, Convert.ToString(temp[i]));    
                        }
                    }
