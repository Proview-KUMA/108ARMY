<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="108_CenterStatus.aspx.cs" Inherits="_108_CenterStatus" %>
        ...
        <ajaxToolkit:TabPanel runat="server" ID="TabPanel1" HeaderText="伺服器狀態">
            <ContentTemplate>
                <div style="margin-top: 5px; margin-bottom: 5px; vertical-align: bottom; height: 22px;">
                    ...
                    <br />
                    <br />
                    <asp:Button ID="btn_PingFec" runat="server" Text="檢查總部伺服器連線狀態" OnClick="btn_PingFec_Click" Font-Size="Larger" BackColor="#66FF33" Width="340px" />
                    ...
                    <br />
                    <br />
                    <asp:Label ID="Label7" runat="server" Text="鑑測站伺服器時間：" Font-Size="Larger"></asp:Label>
                    <asp:Label ID="lab_SvTime" runat="server" Font-Size="Larger"></asp:Label>
                    <br />
                    <br />
                    <asp:Label ID="Label9" runat="server" Text="鑑測站資料庫時間：" Font-Size="Larger"></asp:Label>
