...
<body>
    ...
    <div style="background-image:url('images/logo.bmp'); background-position:right; background-repeat:no-repeat;background-size: 200px; background-position: 80% 20%;">
    ...
    <div style="font-size: large; font-weight:bold; padding-left:60%; padding-bottom:0%"><label id="LB_Date_Re" runat="server"></label></div>
    ...
    <table style="width:100%; ">
        <tbody>
            <tr>
                ...
                <td class="style1">
                    &nbsp;<asp:Image ID="Image1" runat="server" Height="38px" Width="172px" 
                        ImageUrl="~/images/sign1.jpg" ImageAlign="Middle" />
                        </td></tr></tbody></table>
                </td>
            </tr>
            <tr>
                ...
                <td style="width:50%; vertical-align:top; text-align: right; padding-top:6%">鑑測站主任簽章：</td>
                 <td style="width:30%; padding-top:6%">
                    ...
                    <table class="table_div" style="width:100%; height:75px"><tbody><tr class="table_div_tr">
                    <td class="style1">
                    <asp:Image ID="Image2" runat="server" Height="38px" Width="172px" 
