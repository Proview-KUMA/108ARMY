<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="AccMagEdit.aspx.cs" Inherits="AccMagEdit" %>
...
//        $(DomID('txtID')).blur(function() {
//        $.postJson('GetValueByCode.ashx', { mode: 'CheckAccExist', value: $(DomID('txtID')).val() }, function(data, s) {
//                if (s == 'success') {
//                    if (data["status"] == "true") {
//                        $(DomID('txtID')).parent().next().html('已有一筆申請待審核');
//                    }
//                    else {
//                    }
//                }
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
 ...
 <ajaxToolkit:TabPanel runat="server" ID="tabpanel1" HeaderText="新增帳號管理者">
 <ContentTemplate>
 <div>
  <table id="add">
   <tbody>
   ...
   <td>帳號</td>
   <td>
       <asp:TextBox ID="txtAcc" runat="server"></asp:TextBox><span></span></td><td></td>
   </tr>
 ...
 <ajaxToolkit:TabPanel ID="tabpanel2" runat="server" HeaderText="帳號管理員維護">
 <ContentTemplate>
 <div>
     
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
            ConnectionString="<%$ ConnectionStrings:Center %>" 
            SelectCommand="SELECT [account] FROM [Account_c] where [role_code] = '2'"></asp:SqlDataSource>
 </div>
 <div>
 <table id="update">
   <tbody>
