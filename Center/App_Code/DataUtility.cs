...
namespace Lib
{
    ...
    public class DataUtility
    {
        ...
        public DataUtility()
        {
            ...
            _conString = ConfigurationManager.ConnectionStrings["Center"].ConnectionString;
        }

        public DataUtility(ConnectionType type)
        {
            if (type == ConnectionType.MainDB)
            {
                _conString = ConfigurationManager.ConnectionStrings["MainDB"].ConnectionString;
            }
            if (type == ConnectionType.CenterDB)
            {
                _conString = ConfigurationManager.ConnectionStrings["Center"].ConnectionString;
            }
        }
        ...
        /// <summary>
        /// get datatable by stored procedure
        /// </summary>
        ...
        //public Dictionary<string, object> getDataTableBysp(string spName, List<Dictionary<string, object>> list)
        public DataTable getDataTableBysp(string spName, List<Dictionary<string, object>> list)
        {
            DataTable dt = new DataTable();
            using (SqlConnection con = new SqlConnection(_conString))
            {
        ...
        public void executeNonQueryBysp(string spName)
        {
            using (SqlConnection con = new SqlConnection(_conString))
            {
                con.Open();
        ...
        public void executeNonQueryByText(string commandText, string p_name, object value)
        {
            using (SqlConnection con = new SqlConnection(_conString))
            {
                con.Open();
                using (SqlCommand cmd = con.CreateCommand())
                {
                    cmd.CommandText = commandText;
                    cmd.CommandType = CommandType.Text;
                    cmd.Parameters.AddWithValue(p_name, value);
                    cmd.ExecuteNonQuery();
                }
                con.Close();
            }
