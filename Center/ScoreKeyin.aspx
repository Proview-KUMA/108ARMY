    ...
    <script type="text/javascript">
        ...
        $(function () {
            $('#savescore').click(function () {
                ...
                //                document.getElementById("ctl00_ContentPlaceHolder1_TabContainer1_TabPanel1_unit_code").style.display = 'block';
                //                document.getElementById("ctl00_ContentPlaceHolder1_TabContainer1_TabPanel1_rank_code").style.display = 'block';
                //                var unit_code = $('#ctl00_ContentPlaceHolder1_TabContainer1_TabPanel1_unit_code').text();
                //                var rank_code = $('#ctl00_ContentPlaceHolder1_TabContainer1_TabPanel1_rank_code').text();
                ...
                //var item3_sid;
                ////判斷第三項是不是1
                //if (item3_e.options[item3_e.selectedIndex].value == "1") {
                //    item3_sid = "0";
                //    op_id="run_2400"
                //}
                //else {
                //    item3_sid = item3_e.options[item3_e.selectedIndex].value;
                //    op_id = "0";
                //}
                ...
                var run;
                var memo;
                $.postJson('GetValueByCode.ashx', { mode: 'InsertScore', id: $('#id').val(), name: name, birth: birth, gender: gender
                        ...
                        if (s == 'success') {
                            if (data["status"] == "true") {
                                ...
                                $.postJson('GetValueByCode.ashx', { mode: 'GetSitUpsItem', value: data["gender"] }, function (datatest, s) {
                                    ...
                                    for (i in myObject) {
                                        ////2016-11-24加入這一段，人工輸入只有第三項(run)才會出現2400公尺
                                        //if (i > 0) {
...
<ContentTemplate>
<div>
    <p><asp:Calendar ID="datepicker" runat="server" BackColor="White" 
    ...
    <p>鑑測日期 : <asp:TextBox ID="date" runat="server" Enabled="False"></asp:TextBox></p>
</div>

<div id="div_id">
    <p>身分證字號 : <input type="text" id="id" /></p><p id="status"></p>
</div>
...
<div id="playerinfo" style="display:none" >
    <table>
        <tbody>
            <tr>
                <td>性別 : </td>
                <td><asp:Label ID="player_gender" runat="server"></asp:Label></td>
            </tr>
            <tr>
                <td>生日 : </td>
                <td><asp:Label ID="player_birth" runat="server"></asp:Label></td>
            </tr>
             <tr>
                <td>姓名 : </td>
                <td><asp:Label ID="player_name" runat="server"></asp:Label></td>
            </tr>
             <tr>
                <td>單位 : </td>
                <td>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </select> 
            ...
            <tr>
                <td colspan="3"><input id="savescore" type="button" value="成績儲存" /></td>
            </tr>
