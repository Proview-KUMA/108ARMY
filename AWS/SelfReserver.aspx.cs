...
public partial class SelfReserver : System.Web.UI.Page
{
                            ...
                            switch (p1.Value.ToString())
                            {
                                case "canreserve":
                                    try
                                    {
                                        ...
                                        SqlParameter _p13 = new SqlParameter("date", reserveDate);
                                        ...
                                        */
                                        //d.Clear();
                                        //d.Add("center_code", Convert.ToInt32(_center));
                                        //d.Add("date", reserveDate);
                                        dt_reserved.Load(comm.ExecuteReader());
                                        if (Convert.ToInt32(dt_reserved.Rows[0]["allow"]) >= 0)
                                        {
                                            ...
                                            Lib.SysSetting.AddLog("基本項目報進", ((Lib.Player)Session["player"]).ID, "報進成功 , 日期:" + selectDate.Text + " , 地點:" + cneterSel.SelectedItem.Text, System.DateTime.Now);
                                            #endregion
                                        }
                                        else
                                        {
                                ...
                                case "againreserve":
                                    try
                                    {
                                        ...
                                        SqlParameter _p16 = new SqlParameter("date", reserveDate);
                                        comm.Parameters.Add(_p2);
                                        comm.Parameters.Add(_p10);
