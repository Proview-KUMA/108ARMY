...
public partial class SelfReverserChange : System.Web.UI.Page
{
    ...
    protected void Button2_Click(object sender, EventArgs e)
    {
        ...
        {
            if (Lib.SysSetting.CheckYear(Convert.ToDateTime(_selectdate)))
            {
                ...
                else
                {
                    ...
                    if (Convert.ToInt32(dt_again.Rows[0]["count"].ToString()) == 0)
                    {
                        ...
                        du.executeNonQueryBysp("ChangePlayerBySelf", sqls);
                            ...
                            case "canreserve":
                                ...
                                try
                                {
                                    ...
                                    if (Convert.ToInt32(dt_reserved.Rows[0]["allow"]) >= 0)
                                    {
                                        ...
                                        Lib.SysSetting.AddLog("基本項目變更報進", ((Lib.Player)Session["player"]).ID, "變更報進 , 日期:" + newdate.Text + " , 地點:" + newcenter.Text, System.DateTime.Now);
                                        #endregion
                                    }
                                    else
                                    {
